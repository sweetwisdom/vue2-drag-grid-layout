...
export default {
  ...
  methods: {
    ...
    moveEvent: function (i, newX, newY) {
      ...
      //   this.eventLog.push(msg);
      //   将正在移动的元素赋值给movingItem 不是内存地址
      console.log(msg);
      if (this.movingItem) return;
      const tem = this.layout.find((item) => item.i === i);
      this.movingItem = { ...tem, i: tem.i };
      console.log(JSON.stringify(this.movingItem), "🤖🤖");
    },
    movedEvent: function (i, newX, newY) {
      ...
      // 还原正在移动的
      //   this.layout.push(this.movingItem);
